...
function [Fext, Krh, elastic_mod]  = HCF_damp_contact(state,robot,human,...
                                    varargin)
...
%                         + robot.force_skin_max);
        Fext = - robot.stiffness_kcb * ((deformation - robot.deformation_sm)^robot.n_cs) * (deformation_dt *(3/2)*robot.damping_cs + 1);
