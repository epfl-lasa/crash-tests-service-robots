...
%%  %%%%%%%% Simulation parameters for CCF Model ############
    close all; clc;
    ...
    method.contact = 'CCF'; %'CCF' or 'HCF' or 'Spring'
    % % % EA =EB = 2.3e9
...
%     robot.limit_def = 0.8;
    ...
    variable_set = [...
                    ...
                    1.5; % robot.n_c = 1.5;
                    0.9; % robot.n_f = 0.8;
                    2.0; % robot.EA = 5.0  Input in GPa [0.1e9]; %% Fitted Gain --> To be determine
...
%% % Fitting Single model data for HCF
