...
%%  %%%%%%%% Simulation parameters for HCF Model ############
    ...
    human.part = 'tibia_child'; % For collision data
...
%     end     
    ...
    variable_set = [...
                    2.95; %     robot.n_cs = 1.65; 1.9; %     robot.n_cb = 1.8;         2.35; %     robot.n_rb = 2.65;
                    .2; %      robot.Dhr = 7e6;
                    ];
...
%     hold on;
    ...
    % Data to be fitted for Legs Impact
        plot_range8 = find(data_filtered.test_8.time>minTime,1):...
                            find(data_filtered.test_8.time>maxTime,1);
        plot_range9 = find(data_filtered.test_9.time>minTime,1):...
                            find(data_filtered.test_9.time>maxTime,1);
        plot_range10 = find(data_filtered.test_10.time>minTime,1):...
                            find(data_filtered.test_10.time>maxTime,1);
        
        timeSet = downsample([data_filtered.test_8.time(plot_range8) ...
                                data_filtered.test_9.time(plot_range9) ...
                                data_filtered.test_10.time(plot_range10) ], sampDown);
        F_set = downsample([data_filtered.test_8.impact.Fx(plot_range8) ...
                                data_filtered.test_9.impact.Fx(plot_range9)...
                                data_filtered.test_10.impact.Fx(plot_range10)], sampDown);
...
% % % % % % % % % % Fitting Force Data into Gaussians for each Velocity % % % % % % % % 
        maxTime3 = 5; maxTime2 = 10; maxTime1 = 10;
        ...
        [fitresult1, gof1] = FitForceLegs3(time1, F1);
        [fitresult2, gof2] = FitForceLegs3(time2, F2);
